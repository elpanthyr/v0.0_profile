...
export const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 right-4 md:right-40 z-50 w-12 h-12 rounded-full bg-secondary/80 backdrop-blur-sm border border-border shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl active:scale-95"
